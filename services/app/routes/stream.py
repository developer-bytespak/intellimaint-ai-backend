    ...
    try:
        ...
        while True:
            try:
                ...
                response = await service.handle_stream(data, user_id=user_id, websocket=websocket)
                ...
                # 5. Handle Responses (already sent via websocket in service)
